...
namespace ctpl {
    ...
    public:
        ...
        [[maybe_unused]] int n_idle() { return this->nWaiting; }

        [[maybe_unused]] std::thread &get_thread(int i) { return *this->threads[i]; }
        ...
        void stop(bool isWait = false) {
            ...
            for (int i = 0; i <
                            static_cast<int>(this->threads.size()); ++i) {  // wait for the computing threads to finish
